...
<script type="text/javaScript" language="javascript">
	...
	function fn_egov_inqire_roughmaplist() {
		...
		//location.href = "<c:url value='/com/uss/ion/rmm/selectRoughMapList.do'/>";
	}
...
<form id="roughMap" name="roughMap" method="post" action="<c:url value='/com/uss/ion/rmm/updateRoughMapView.do'/>" >
...
<input type="hidden" id="pageIndex" name="pageIndex" value="${searchVO.pageIndex}" />
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/com/uss/ion/rmm/updateRoughMapView.do'/>?roughMapId=<c:out value='${roughMap.roughMapId}'/>" ><spring:message code="button.update" /></a></span>
				
		<span class="btn_s"><a href="<c:url value='/com/uss/ion/rmm/deleteRoughMap.do'/>?roughMapId=<c:out value='${roughMap.roughMapId}'/>" ><spring:message code="button.delete" /></a></span>
				
		<span class="btn_s"><a href="<c:url value='/com/uss/ion/rmm/selectRoughMapList.do'/>?pageIndex=<c:out value='${roughMap.pageIndex}'/>&amp;searchKeyword=<c:out value="${roughMap.searchKeyword}"/>&amp;searchCondition=1" ><spring:message code="button.list" /></a></span>
	</div>
