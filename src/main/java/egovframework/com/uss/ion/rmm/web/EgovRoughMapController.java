...
public class EgovRoughMapController {
    ...
    */
    ...
    public String selectRoughMapDetail(RoughMapVO searchVO, ModelMap model) throws Exception {
    ...
    */
    ...
    public String goRoughMapUpdt(
    		@RequestParam("roughMapId") String roughMapId,
    		@ModelAttribute("roughMap") RoughMapVO roughMap, 
